          ...
          >
            ...
            <div class="timeline-card">
              ...
              <div class="card-body">
                ...
                <!-- DO_NOTHING: No operation (silent) -->
                ...
                <!-- General fallback: Unknown type or content exists but not handled above -->
...
const props = defineProps({
  simulationId: String,
  maxRounds: Number, // Maximum rounds passed from Step 2
  minutesPerRound: {
    type: Number,
...
// Simulation elapsed time for Twitter platform
const twitterElapsedTime = computed(() => {
  return formatElapsedTime(runStatus.value.twitter_current_round || 0)
})

// Simulation elapsed time for Reddit platform
...
// Track previous round of each platform to detect changes and output logs
...
const fetchRunStatus = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Detect round changes for each platform and output logs respectively
...
// Autodetect phase === 2 and advance if autopilot is enabled
